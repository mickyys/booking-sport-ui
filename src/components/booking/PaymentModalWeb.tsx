...
interface PaymentModalWebProps {
  slot: TimeSlot;
  court: Court;
  onClose: () => void;
...
export const PaymentModalWeb: React.FC<PaymentModalWebProps> = ({
  slot,
  court,
  onClose,
  onConfirm,
  ...
  return (
    <>
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden max-h-[90vh] overflow-y-auto flex flex-col"
      >
        <div className="bg-slate-900 p-6 text-white flex justify-between items-start shrink-0 rounded-t-2xl">
          <div>
        ...
        <div className="p-6 overflow-y-auto flex-1 pb-6">
