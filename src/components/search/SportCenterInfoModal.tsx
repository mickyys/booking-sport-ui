...
const SportCenterInfoModal: React.FC<SportCenterInfoModalProps> = ({ center, isOpen, onClose }) => {
  ...
  const googleMapsUrl = center.coordinates
  ...
  const wazeUrl = center.coordinates
    ? `https://waze.com/ul?ll=${center.coordinates.lat},${center.coordinates.lng}&navigate=yes`
    : null;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-lg p-0 max-h-[90vh] overflow-y-auto border-none shadow-2xl no-scrollbar">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 leading-relaxed mb-4">{center.address}</p>
