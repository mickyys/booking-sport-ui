...
import { MapPin, Clock, Grid, List, CheckCircle } from 'lucide-react';
            ...
            <div className="bg-slate-100 p-1 rounded-xl flex">
                <button 
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${
                        viewMode === 'single' ? 'bg-white shadow-sm text-slate-900' : 'text-slate-500 hover:text-slate-900'
                    }`}
                >
                ...
                <button 
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${
                        viewMode === 'all' ? 'bg-white shadow-sm text-slate-900' : 'text-slate-500 hover:text-slate-900'
                    }`}
                >
        ...
        {days.map((day) => {
          ...
          return (
            <button
              ...
              className={`flex-shrink-0 flex flex-col items-center justify-center min-w-[80px] h-20 rounded-2xl border transition-all ${
                isSelected 
